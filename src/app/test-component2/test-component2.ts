...
@Component({
    ...
    providers: [
		{ provide: NG_VALUE_ACCESSOR, multi: true, useExisting: TestComponent2 },
		{ provide: NG_VALIDATORS, multi: true, useExisting: TestComponent2 }
	]
})
export class TestComponent2 implements OnInit, ControlValueAccessor, Validator, DynamicComponentInterface {
    ...
    constructor(private fb: FormBuilder) {
        this.form = this.fb.group({
            selectedColor: ['', Validators.minLength(4)]
        });
    }
